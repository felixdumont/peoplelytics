...
def mock_incidents(df):
    ...
    death_risk = (1 + df['driver_death_add_risk'])*(1 + df['truck_death_add_risk'])*(1 + df['route_risk'])
    major_risk = (1 + df['driver_major_add_risk'])*(1 + df['truck_major_add_risk'])*(1 + df['route_risk'])
    minor_risk = (1 + df['driver_minor_add_risk'])*(1 + df['truck_minor_add_risk'])*(1 + df['route_risk'])
