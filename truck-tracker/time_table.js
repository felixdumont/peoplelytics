...
exports.TimeTable = class {
  ...
  publishTimeTables(now) {
    ...
    //console.log("Route: " + route_id); ///// ----------------- DEBUG --------------- ////
    //console.log("Left: " + left + " Right: " + right); ///// ----------------- DEBUG --------------- ////
  ...
  tripsLookup(route_id, now) {
    ...
    console.log("Route: " + route_id + "Now: " + now + " date: " + date + " time: " + time); ///// ----------------- DEBUG --------------- ////
      ...
      if (
        ...
        ptt.routes[0].legs.forEach(leg => {
          ...
          const time_display = round_moment(time).format('HH:mm:ss');
            ...
            console.log("Time: " + time_display); ///// ----------------- DEBUG --------------- ////
